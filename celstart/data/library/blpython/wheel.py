# behaviour that can be used as a base to control front wheel from some
# vehicle.
# Uses: commandinput,echanicsobject,mechanicsjoint, mesh
...
class wheel:
	...
	def __init__(self,celEntity):
		...
		self.myjoint.SetSuspensionCFM(0.0003)
		...
		self.input.Bind("a", "rotateleft")
		self.input.Bind("d", "rotateright")
		self.GearForce=[]
		self.GearVel=[]
